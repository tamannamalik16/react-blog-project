...
export default function Login () {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("/auth/login", {        // username or password, passing values to /login
    ...
    return(
        <div className="login">
            ...
            <form  className="loginForm" onSubmit={handleSubmit}>
                ...
                <input type="password" className="loginInput" placeholder="enter your pass" ref={passwordRef}></input>
